...
use Fran\PostBundle\Form\TaxonomyType;
...
class TaxonomyController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('FranPostBundle:Taxonomy')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('FranPostBundle:Taxonomy')->find($id);
     ...
     * @Method("post")
     * @Template("FranPostBundle:Taxonomy:new.html.twig")
     */
     ...
     * @Method("post")
     * @Template("FranPostBundle:Taxonomy:edit.html.twig")
     */
